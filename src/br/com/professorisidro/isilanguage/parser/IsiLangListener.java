...
public interface IsiLangListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#condition}.
	 * @param ctx the parse tree
	 */
	void enterCondition(IsiLangParser.ConditionContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#condition}.
	 * @param ctx the parse tree
	 */
	void exitCondition(IsiLangParser.ConditionContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link IsiLangParser#expr_texto}.
	 * @param ctx the parse tree
	 */
	void enterExpr_texto(IsiLangParser.Expr_textoContext ctx);
	/**
	 * Exit a parse tree produced by {@link IsiLangParser#expr_texto}.
	 * @param ctx the parse tree
	 */
	void exitExpr_texto(IsiLangParser.Expr_textoContext ctx);
}